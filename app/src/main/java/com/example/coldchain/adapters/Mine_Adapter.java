...
import com.example.coldchain.b_mine_activity.Charging;
...
public class Mine_Adapter extends RecyclerView.Adapter {
    ...
    public Mine_Adapter(List<B_Mine> goodsList) {
            ...
            case TYPE_FORE:
                ...
                holder4.cardView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        B_Mine b_mine = goodsList.get(position);
                        switch (position){
                            case 1:
                                Toast.makeText(v.getContext(),"支付" , Toast.LENGTH_SHORT).show();
                                break;
                            case 2:
                                Toast.makeText(v.getContext(),"定位", Toast.LENGTH_SHORT).show();
                                break;
                            case 3:
                                Toast.makeText(v.getContext(),"充电住" , Toast.LENGTH_SHORT).show();
                                Intent charing=new Intent(v.getContext(), Charging.class);
                                v.getContext().startActivity(charing);
                                break;
                            case 4:
                                Intent Car_situation=new Intent(v.getContext(), Car_situation.class);
                                v.getContext().startActivity(Car_situation);
                                break;
                            case 5:
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        switch (holder.getItemViewType()){
            case TYPE_ONE:
                ...
                B_Mine dingDanBean=goodsList.get(position);
            ...
            case TYPE_TWO:
                ...
                B_Mine goods = goodsList.get(position);
