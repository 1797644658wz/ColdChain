...
public class BuyFragmentMain2_children1 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (null != view) {
            ...
            view = inflater.inflate(R.layout.buyfragmentmain2_children1, null);
            //初始化控件
            initview();
    ...
    private void initview() {
        recyclerView=view.findViewById(R.id.b2_recyclerview_children1);
    }
}
